...
setup(
    name="scan-aware-mamba",
    version="1.0.0",

    description=(
        "Official implementation of Scan-Aware Mamba for fine-grained "
        "Type-B aortic dissection segmentation."
    ),

    url="https://github.com/weixingli714/Scan-Aware-Mamba",
